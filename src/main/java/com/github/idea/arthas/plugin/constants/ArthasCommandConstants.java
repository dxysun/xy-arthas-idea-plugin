...
public interface ArthasCommandConstants {
    ...
    /**
     * watch/tt 观察表达式 入参变量名 默认值 官方为 params
     */
    String DEFAULT_WATCH_PARAMS_VARIABLE = "parameterArray";

    /**
     * watch/tt 观察表达式 异常变量名 默认值 官方为 throwExp
     */
    String DEFAULT_WATCH_THROW_VARIABLE = "throwable";
