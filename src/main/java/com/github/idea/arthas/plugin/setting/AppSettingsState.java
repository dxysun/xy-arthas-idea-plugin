...
public class AppSettingsState implements PersistentStateComponent<AppSettingsState> {
    ...
    /**
     * watch/tt 观察表达式 入参变量名 eg params/parameterArray
     */
    public String watchParamsVariable = DEFAULT_WATCH_PARAMS_VARIABLE;

    /**
     * watch/tt 观察表达式 异常变量名 eg throwExp/throwable
     */
    public String watchThrowVariable = DEFAULT_WATCH_THROW_VARIABLE;
    ...
    public static AppSettingsState getInstance(@NotNull Project project) {
        ...
        // 检查全局的 watch 观察表达式变量名
        checkGlobalWatchExpressVariable(appSettingsState);
    ...
    /**
     * 设置全局的 watch/tt 观察表达式变量名
     *
     * @param appSettingsState
     */
    private static void checkGlobalWatchExpressVariable(AppSettingsState appSettingsState) {
        String globalWatchParamsVariable = PropertiesComponentUtils.getValue("watchParamsVariable");
        String globalWatchThrowVariable = PropertiesComponentUtils.getValue("watchThrowVariable");
        if (StringUtils.isNotBlank(globalWatchParamsVariable)) {
            appSettingsState.watchParamsVariable = globalWatchParamsVariable;
        }
        if (StringUtils.isNotBlank(globalWatchThrowVariable)) {
            appSettingsState.watchThrowVariable = globalWatchThrowVariable;
        }
    }
