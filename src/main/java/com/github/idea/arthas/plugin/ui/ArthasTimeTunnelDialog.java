...
public class ArthasTimeTunnelDialog extends JDialog {
    ...
    private void init() {
        ...
        comboBoxValueGetButton.addActionListener(e -> {
            ...
            selectedItemStr = this.replaceWatchExpressVariable(selectedItemStr);
        ...
        comboBox.setRenderer(new DefaultListCellRenderer() {
            ...
            public Component getListCellRendererComponent(JList list, Object value,
                ...
                codeValue = replaceWatchExpressVariable(codeValue);
                if (isSelected) {
     ...
     * @return
     */
    private String replaceWatchExpressVariable(String command) {
        if (StringUtils.isBlank(command)) {
            return command;
        }
        AppSettingsState settings = AppSettingsState.getInstance(project);
        return command.replace(ShellScriptVariableEnum.WATCH_PARAMS.getCode(), settings.watchParamsVariable)
                .replace(ShellScriptVariableEnum.WATCH_THROW.getCode(), settings.watchThrowVariable);
    }
