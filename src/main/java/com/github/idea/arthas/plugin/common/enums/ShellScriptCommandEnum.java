...
public enum ShellScriptCommandEnum implements EnumCodeMsg<String> {
    ...
    WATCH_STATIC_FILED("watch "
            + ShellScriptVariableEnum.CLASS_NAME.getCode() + " * "
            + " '{" + ShellScriptVariableEnum.WATCH_PARAMS.getCode() + ",returnObj," + ShellScriptVariableEnum.WATCH_THROW.getCode() + ",@" + ShellScriptVariableEnum.CLASS_NAME.getCode() + "@" + ShellScriptVariableEnum.FIELD_NAME.getCode() + "}'"
    ...
    WATCH_NON_STATIC_FILED("watch "
            ...
            + " '{" + ShellScriptVariableEnum.WATCH_PARAMS.getCode() + ",returnObj," + ShellScriptVariableEnum.WATCH_THROW.getCode() + ",target." + ShellScriptVariableEnum.FIELD_NAME.getCode() + "}' "
            + ShellScriptVariableEnum.PRINT_CONDITION_RESULT.getCode() + " -n "
            + ShellScriptVariableEnum.INVOKE_COUNT.getCode() + " "
            + " -x "
            + ShellScriptVariableEnum.PROPERTY_DEPTH.getCode() + " "
    ...
    WATCH("watch "
            + ShellScriptVariableEnum.CLASS_NAME.getCode() + " "
            + ShellScriptVariableEnum.METHOD_NAME.getCode() + " "
            + "'{" + ShellScriptVariableEnum.WATCH_PARAMS.getCode() + ",returnObj," + ShellScriptVariableEnum.WATCH_THROW.getCode() + "}' "
            + ShellScriptVariableEnum.PRINT_CONDITION_RESULT.getCode() + " -n "
            + ShellScriptVariableEnum.INVOKE_COUNT.getCode() + " "
            + " -x "
            + ShellScriptVariableEnum.PROPERTY_DEPTH.getCode() + " "
    ...
    WATCH_EXECUTE_STATIC_METHOD("watch "
            + ShellScriptVariableEnum.CLASS_NAME.getCode() + " * "
            + " '{" + ShellScriptVariableEnum.WATCH_PARAMS.getCode() + ",returnObj," + ShellScriptVariableEnum.WATCH_THROW.getCode() + ",@" + ShellScriptVariableEnum.CLASS_NAME.getCode() + "@" + ShellScriptVariableEnum.EXECUTE_INFO.getCode() + "}' "
            + ShellScriptVariableEnum.PRINT_CONDITION_RESULT.getCode() + " -n "
            + ShellScriptVariableEnum.INVOKE_COUNT.getCode() + " "
            + " -x "
            + ShellScriptVariableEnum.PROPERTY_DEPTH.getCode() + " "
    ...
    WATCH_EXECUTE_NO_STATIC_METHOD("watch "
            + ShellScriptVariableEnum.CLASS_NAME.getCode() + " * "
            + " '{" + ShellScriptVariableEnum.WATCH_PARAMS.getCode() + ",returnObj," + ShellScriptVariableEnum.WATCH_THROW.getCode() + ",target." + ShellScriptVariableEnum.EXECUTE_INFO.getCode() + "}'"
            + ShellScriptVariableEnum.PRINT_CONDITION_RESULT.getCode() + " -n "
            + ShellScriptVariableEnum.INVOKE_COUNT.getCode() + " "
            + " -x "
            + ShellScriptVariableEnum.PROPERTY_DEPTH.getCode() + " "
