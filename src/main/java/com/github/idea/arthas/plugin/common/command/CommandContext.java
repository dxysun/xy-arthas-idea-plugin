...
public class CommandContext {
    ...
    private synchronized void initContextParam() {
        ...
        params.put(ShellScriptVariableEnum.WATCH_PARAMS.getEnumMsg(), instance.watchParamsVariable);
        params.put(ShellScriptVariableEnum.WATCH_THROW.getEnumMsg(), instance.watchThrowVariable);
